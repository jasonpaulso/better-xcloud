  ...
  static renderSettings() {
    ...
    const actions: {
      ...
      [t('better-xcloud')]: {
        ...
        [ShortcutAction.TOGGLE_AWAY_MODE_HEAL]: ['Away Mode — Heal', t('toggle')],
        [ShortcutAction.TOGGLE_AWAY_MODE_PIVOT]: ['Away Mode — Pivot', t('toggle')],
        [ShortcutAction.TOGGLE_AWAY_MODE_AWAY]: ['Away Mode — Away', t('toggle')],
      ...
      [t('stream')]: {
        ...
        [ShortcutAction.STREAM_VOLUME_INC]: getPref(PrefKey.AUDIO_ENABLE_VOLUME_CONTROL) && [
          t('volume'),
          t('increase'),
        ],
        [ShortcutAction.STREAM_VOLUME_DEC]: getPref(PrefKey.AUDIO_ENABLE_VOLUME_CONTROL) && [
          t('volume'),
          t('decrease'),
        ],
    ...
    const $container = CE(
      ...
      CE('div', {}, CE('p', { class: 'bx-shortcut-note' }, t('controller-shortcuts-connect-note'))),
